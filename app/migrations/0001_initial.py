# Generated by Django 4.2.1 on 2024-07-02 15:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.ForeignKey(choices=[[0, 'Creada'], [1, 'Rectificada']], on_delete=django.db.models.deletion.CASCADE, to='app.estado')),
                ('estado_entrega', models.ForeignKey(choices=[[0, 'Por entregar'], [1, 'Entregado'], [2, 'Rechazado']], on_delete=django.db.models.deletion.CASCADE, to='app.estadoentrega')),
            ],
            options={
                'db_table': 'db_factura',
            },
